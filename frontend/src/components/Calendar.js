...
const Calendar = ({ dob, onDateSelect }) => {
    ...
    const handleDateClick = (day) => {
        ...
        const formattedDOB = newDate.toLocaleDateString('en-GB');
        setSelectedDOB(formattedDOB);
    
        setIsDatePickerOpen(false);
        console.log('Selected Date of Birth:', formattedDOB);
    
        if (onDateSelect) {
            onDateSelect(formattedDOB);
        }
    };
